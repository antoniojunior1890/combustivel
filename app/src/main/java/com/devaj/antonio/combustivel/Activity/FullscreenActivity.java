...
//        photoView.setImageResource(R.drawable.cissma1);
...
//                    .into(photoView);
        ...
        else if(intent.getSerializableExtra("imagemInformacao") != null){
            Informacao informacao = (Informacao) intent.getSerializableExtra("imagemInformacao");

            Picasso.get()
                    .load(informacao.getImagemInformacao())
//                .load(intent.getStringExtra("imagem"))
                    .placeholder (R.drawable.loading)
                    .error (R.drawable.sem_foto)
                    .into(photoView);
        }
